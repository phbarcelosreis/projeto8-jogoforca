const palavras = [
    ...
    "mamão", "manga", "morango", "mico", "matar", "mingau", "moqueca", "macacão", "maçaneta", 
    ...
    "pato", "polvo", "povoar", "pólvora", "palhaço", "pano", "princesa", "pizza", "patroa", 
